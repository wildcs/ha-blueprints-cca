...
- ✨ **Feature:** New option for reset manual override *"Above or below position"*. This option will reset the manual override if blind is above or below setposition for 2 minutes
